...
public class E07Overloading {
		...
		// 주민번호와 군인을 매개변수로 정의한 메서드(남자들 표현)
		...
		/*Error가 발생하는 이유 : 해당 메서드는 앞에서 선언한 것과 반환타입만 다른 경우이므로 person(10)으로 호출한다 
		가정했을 때 어떤 메서드를 호출할지 애매하므로 에러가 발생된다. 따라서 아래의 메서드는 오버로딩이 성립되지 않는다.
		(선 : void person 후 : int person)
		*/
...
//		}
		...
		public static void main(String[] args) {
			...
			/*
			 ...
			 정수. 실수, 문자 등 모든 타입에 대해 출력할 수 있도록 정의되어잇다.
			 */
